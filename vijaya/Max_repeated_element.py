# find the maximum repeated element in a given list
...
for ele in range(len(my_list) - 1):
    ...
    if my_list[ele] < my_list[ele + 1]:
        ...
        if count > max_inc:
            max_inc = count
        count = 0
# Updating the maximum increment value if count is greater than max increment
if count > max_inc:
    max_inc = count
print("Max increment is:", max_inc)i
